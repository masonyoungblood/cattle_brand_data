...
A random subset of 1,500 brand codes (exported as *brands_to_check.csv*) will be manually checked by three research assistants to estimate the accuracy of the OCR pipeline. The result of OCR is a combined dataframe of cattle brands and zip codes with the corresponding pages and years (example below).
